...
class ProfileVC: UIViewController,UITextViewDelegate {
   ...
   var  phonetobeUpdate = ""
    ...
    override func viewDidLoad() {
        ...
        viewAddCardBtn.layer.cornerRadius = viewAddCardBtn.layer.frame.height / 2
        viewAddCardBtn.layer.borderWidth = 1
        viewAddCardBtn.layer.borderColor = UIColor.lightGray.cgColor
        ...
        self.cardNumTblV.register(UINib(nibName: "CardTblVCell", bundle: nil), forCellReuseIdentifier: "CardTblVCell")
        self.cardNumTblV.delegate = self
        self.cardNumTblV.dataSource = self
    ...
    @IBAction func btnEditAboutMe_Tap(_ sender: UIButton) {
        ...
        if isAboutMeStatus {
            ...
            if txtV_AboutMe.text != placeholderText {
                ...
                viewModel.apiForUpdateAboutMe(AboutMe: self.txtV_AboutMe.text)
            ...
            if txtV_AboutMe.text == placeholderText {
                txtV_AboutMe.text = ""
                txtV_AboutMe.textColor = UIColor.black
            }
        }
...
extension ProfileVC : UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = cardNumTblV.dequeueReusableCell(withIdentifier: "CardTblVCell", for: indexPath) as! CardTblVCell
        if indexPath.row == 0{
            cell.preferredLbl.isHidden = false
        }else{
            cell.preferredLbl.isHidden = true
        }
        DispatchQueue.main.async {
            self.tblVH_Const.constant = self.cardNumTblV.contentSize.height
            self.cardNumTblV.layoutIfNeeded()
        }
        return cell
    }
        ...
        viewModel.$getMyProfileResult
            ...
            .sink { [weak self] result in
                ...
                result?.handle(success: { response in
                    ...
                    if self.txtV_AboutMe.text == "Description" {
...
extension ProfileVC: GMSAutocompleteViewControllerDelegate {
    ...
    func viewController(_ viewController: GMSAutocompleteViewController, didAutocompleteWith place: GMSPlace) {
        ...
        if place.name != nil {
            ...
            viewModel.apiForAddPlace(PlaceName: "\(place.name ?? "")")
...
extension ProfileVC :DPOTPViewDelegate{
