...
//                }
//                
//                vc.backAction = { str,favStatus in
//                    print("\(str) Block Status Received")
//                    print("\(favStatus) favStatus Received")
//                    let isblockedStatus = str
//                    if isblockedStatus == "0" {
...
//        print("RAVI")
//        // Set up the dropdown
//        var blockedStatus = chatDataArr[sender.tag].isBlocked ?? 0
//        self.index = sender.tag
//        if blockedStatus == 0 {
//            Arr[3] = "Block"
//        }
...
//            if item == "Delete chat" {
//                
//                deleteConversation(groupName: chatDataArr[sender.tag].groupName ?? "") { success, errorMessage in
//                    if success {
//                        print("TESTING: Chat deleted successfully.")
//
//                        // Find the index of the chat to delete
//                        if let index = self.chatDataArr.firstIndex(where: { $0.groupName == self.chatDataArr[sender.tag].groupName }) {
//                            self.chatDataArr.remove(at: index)
//                            DispatchQueue.main.async {
//                                self.tblV.reloadData()
//                            }
//                        }
